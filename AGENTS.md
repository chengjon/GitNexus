...
This project is indexed by GitNexus as **GitNexus** (2064 symbols, 4478 relationships, 153 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
