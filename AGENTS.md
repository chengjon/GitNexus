...
This project is indexed by GitNexus as **GitNexus** (2242 symbols, 4839 relationships, 165 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
