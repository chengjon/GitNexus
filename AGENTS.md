...
This project is indexed by GitNexus as **GitNexus** (2356 symbols, 5079 relationships, 172 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
