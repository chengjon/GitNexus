...
This project is indexed by GitNexus as **GitNexus** (2255 symbols, 4872 relationships, 166 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
