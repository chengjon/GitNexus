...
- **GitNexus:** standard skills in `.claude/skills/gitnexus-*/`; MCP rules in the `gitnexus:start` block below (full text: [docs/law/gitnexus-agent-rules.md](docs/law/gitnexus-agent-rules.md)).
