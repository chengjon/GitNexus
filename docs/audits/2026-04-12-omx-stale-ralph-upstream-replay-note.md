...
- later verified fork-only stop point on the same branch: `46622fa` `Preserve repo-local stale evidence across Windows paths`
...
point remains: closed PR `#1509`, owner closure note, and verified fork-only stop point
`46622fa`.
