...
`gitnexus-refactoring`, and `gitnexus-pr-review`, while `gitnexus-debugging`
has absorbed the suggested regression-debugging note.
...
| `gitnexus-exploring/SKILL.md` | 已有后续收敛记录；不应再按本表原样视为待办 |
