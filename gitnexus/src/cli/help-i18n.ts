...
const COMMAND_DESCRIPTION_KEYS = {
  ...
  'refresh-context': 'help.command.refreshContext.description',
  config: 'help.command.config.description',
  'config embeddings': 'help.command.config.embeddings.description',
  'config embeddings show': 'help.command.config.embeddings.show.description',
  'config embeddings set': 'help.command.config.embeddings.set.description',
  'config embeddings clear': 'help.command.config.embeddings.clear.description',
  ...
  'verify-staged': 'help.command.verifyStaged.description',
...
const OPTION_DESCRIPTION_KEYS = {
  ...
  'refresh-context|--skip-agents-md': 'help.option.refreshContext.skipAgentsMd',
  'refresh-context|--no-stats': 'help.option.refreshContext.noStats',
  'refresh-context|--skip-skills': 'help.option.refreshContext.skipSkills',
  'config embeddings set|--provider <provider>': 'help.option.config.embeddings.provider',
  'config embeddings set|--embedding-url <url>': 'help.option.config.embeddings.url',
  'config embeddings set|--embedding-model <model>': 'help.option.config.embeddings.model',
  'config embeddings set|--embedding-api-key <key>': 'help.option.config.embeddings.apiKey',
  'config embeddings set|--embedding-dims <n>': 'help.option.config.embeddings.dims',
  'config embeddings set|--ollama-base-url <url>': 'help.option.config.embeddings.ollamaBaseUrl',
  'config embeddings set|--ollama-model <model>': 'help.option.config.embeddings.ollamaModel',
  'config embeddings set|--node-limit <n>': 'help.option.config.embeddings.nodeLimit',
  'config embeddings set|--batch-size <n>': 'help.option.config.embeddings.batchSize',
  'config embeddings set|--sub-batch-size <n>': 'help.option.config.embeddings.subBatchSize',
  'config embeddings set|--threads <n>': 'help.option.config.embeddings.threads',
  'config embeddings set|--device <device>': 'help.option.config.embeddings.device',
  ...
  'doctor|--host <name>': 'help.option.doctor.host',
  'doctor|--repo <path>': 'help.option.doctor.repo',
  'doctor|--gpu': 'help.option.doctor.gpu',
  'doctor|--fix': 'help.option.doctor.fix',
  'doctor|--json': 'help.option.json',
  ...
  'verify-staged|-r, --repo <name>': 'help.option.repo.target',
  'verify-staged|--cwd <path>': 'help.option.detectChanges.cwd',
  'verify-staged|--worktree <path>': 'help.option.detectChanges.worktree',
  'verify-staged|--json': 'help.option.json',
  ...
  'analyze|--files <path...>': 'help.option.analyze.files',
} satisfies Record<string, CliMessageKey>;
