export const en = {
  ...
  'tool.detectChanges.noIndexedSymbols': 'No indexed symbols matched changed hunks.',
  ...
  'tool.detectChanges.metadataHeader': 'Index context:',
  'tool.detectChanges.metadataRepository': 'Repository: {{repo}}',
  'tool.detectChanges.metadataRepoPath': 'Repo path: {{path}}',
  'tool.detectChanges.metadataDiffPath': 'Git diff path: {{path}}',
  'tool.detectChanges.metadataCwd': 'Process cwd: {{path}}',
  'tool.detectChanges.metadataIndexStatus': 'Index status: {{status}}',
  'tool.detectChanges.metadataCommits': 'Commits: indexed {{indexed}}, current {{current}}',
  ...
  'help.command.verifyStaged.description':
    'Agent-safe staged scope verification using detect_changes',
  ...
  'help.option.doctor.host': 'Check a specific host configuration',
  'help.option.doctor.repo': 'Check a specific repository path',
  'help.option.doctor.gpu': 'Also include GPU readiness checks',
  'help.option.doctor.fix': 'Include safe fix guidance when available',
  ...
  'help.option.detectChanges.cwd': 'Working directory hint for linked worktree detection',
  'help.option.detectChanges.worktree': 'Explicit linked worktree path for git diff',
  ...
  'help.option.analyze.stagedOnly': 'Only analyze files staged in git index',
  'help.option.analyze.changedOnly': 'Only analyze files changed vs HEAD',
  'help.option.analyze.files': 'Only analyze specific file paths (repo-relative)',
