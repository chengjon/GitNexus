...
- [x] 1.1 Add a dedicated OpenSpec change for structured host-detect-changes guidance output
- [x] 1.2 Bound the slice to `host-detect-changes-guidance` transport only

## 2. Test-First Coverage

- [x] 2.1 Add focused doctor regression coverage for Codex guidance data
- [x] 2.2 Add focused doctor regression coverage for Claude Code guidance data
- [x] 2.3 Run the focused test and confirm it fails before implementation

## 3. Structured Output Convergence

- [x] 3.1 Add structured `data` to `host-detect-changes-guidance` checks
- [x] 3.2 Reuse existing host-specific guidance semantics
