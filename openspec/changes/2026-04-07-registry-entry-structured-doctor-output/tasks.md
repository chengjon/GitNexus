...
- [x] 1.1 Add a dedicated OpenSpec change for structured registry-entry doctor output
- [x] 1.2 Bound the slice to `registry-entry` transport only

## 2. Test-First Coverage

- [x] 2.1 Add focused doctor regression coverage for matched registry-entry data
- [x] 2.2 Add focused doctor regression coverage for unmatched registry-entry data
- [x] 2.3 Run the focused test and confirm it fails before implementation

## 3. Structured Output Convergence

- [x] 3.1 Add structured `data` to `registry-entry` checks
- [x] 3.2 Reuse existing repo path and matched registry entry
