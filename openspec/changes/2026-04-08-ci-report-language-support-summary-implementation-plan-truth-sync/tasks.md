...
- [x] 1.1 Add a dedicated OpenSpec change for the CI report language-support
      summary implementation-plan truth sync
...
- `openspec validate 2026-04-08-ci-report-language-support-summary-implementation-plan-truth-sync`
  returned `Change '2026-04-08-ci-report-language-support-summary-implementation-plan-truth-sync' is valid`
...
- interpretation:
  ...
  code and doc changes elsewhere in the repository; this truth-sync slice
