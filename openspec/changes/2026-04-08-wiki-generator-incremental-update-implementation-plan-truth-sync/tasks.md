...
- [x] 1.1 Add a dedicated OpenSpec change for the wiki incremental-update implementation-plan truth sync
...
- [x] 2.4 Reconfirm the planned incremental-update source and test anchors exist in the repo
...
- `openspec validate 2026-04-08-wiki-generator-incremental-update-implementation-plan-truth-sync`
  returned `Change '2026-04-08-wiki-generator-incremental-update-implementation-plan-truth-sync' is valid`
- `gitnexus_detect_changes({scope: "all", repo: "GitNexus", cwd: "/opt/claude/GitNexus"})`
  returned `risk_level=critical`, `changed_files=87`, `changed_count=250`,
