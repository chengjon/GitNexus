...
- [x] 1.1 Add a dedicated OpenSpec change for full-generation review
      body-boundary sync
...
- [x] 2.1 Re-read the current top status-sync framing in the 2026-03-28 review
- [x] 2.2 Re-read the `Verdict` and `Summary` entry points
- [x] 2.3 Reconfirm the 2026-04-08 review truth-sync record
- [x] 2.4 Reconfirm the related technical-debt audit note and remediation roadmap
...
- [x] 3.3 Keep the original issue and landed-resolution text intact
...
- `openspec validate 2026-04-15-full-generation-review-body-boundary-sync`
  returned `Change '2026-04-15-full-generation-review-body-boundary-sync' is valid`
...
- interpretation:
  the staged review stayed within the expected full-generation historical
