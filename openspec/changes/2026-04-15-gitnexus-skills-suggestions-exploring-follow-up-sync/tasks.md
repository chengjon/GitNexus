...
- [x] 1.1 Add a dedicated OpenSpec change for historical skills-suggestions
...
- [x] 2.1 Re-read the current historical suggestions status-sync note
- [x] 2.2 Re-read the current follow-up snapshot rows
...
- [x] 3.2 Update the snapshot table with the current-state reading for
      `gitnexus-exploring`
- [x] 3.3 Keep the historical 2026-03-26 suggestion body intact
...
- `openspec validate 2026-04-15-gitnexus-skills-suggestions-exploring-follow-up-sync`
  returned `Change '2026-04-15-gitnexus-skills-suggestions-exploring-follow-up-sync' is valid`
