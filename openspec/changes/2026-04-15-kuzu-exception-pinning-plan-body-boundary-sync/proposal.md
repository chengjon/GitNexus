...
The historical `docs/superpowers/plans/2026-04-06-kuzu-dependency-exception-pinning-implementation-plan.md`
...
mistaken for a current active dependency-pinning plan.
...
- `kuzu-exception-pinning-plan-body-boundary-sync`: Keep the preserved body of
  the 2026-04-06 `kuzu` dependency exception-pinning implementation plan clearly
  marked as historical planning context.
...
- Affected docs:
  ...
  - `docs/audits/2026-04-15-kuzu-exception-pinning-plan-body-boundary-sync.md`
  - `openspec/changes/2026-04-15-kuzu-exception-pinning-plan-body-boundary-sync/**`
- Reused truth sources:
  - current 2026-04-06 `kuzu` exception-pinning implementation plan
  - current 2026-04-06 `kuzu` exception-pinning OpenSpec record
