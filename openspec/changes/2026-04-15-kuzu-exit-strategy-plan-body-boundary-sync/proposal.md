...
The historical `docs/superpowers/plans/2026-04-06-kuzu-dependency-exit-strategy-implementation-plan.md`
...
mistaken for a current active dependency-governance plan.
...
- `kuzu-exit-strategy-plan-body-boundary-sync`: Keep the preserved body of the
  2026-04-06 `kuzu` exit-strategy implementation plan clearly marked as
...
- Affected docs:
  ...
  - `docs/audits/2026-04-15-kuzu-exit-strategy-plan-body-boundary-sync.md`
  - `openspec/changes/2026-04-15-kuzu-exit-strategy-plan-body-boundary-sync/**`
- Reused truth sources:
  - current 2026-04-06 `kuzu` exit-strategy implementation plan
  - current 2026-04-06 `kuzu` exit-strategy audit and OpenSpec records
