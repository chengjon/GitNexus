...
- [x] 1.1 Add a dedicated OpenSpec change for MCP process review body-boundary sync
- [x] 1.2 Bound the slice to the historical review, audit note, roadmap update,
      and OpenSpec record

## 2. Truth Source

- [x] 2.1 Re-read the current top status-sync framing in the 2026-04-05 review
- [x] 2.2 Re-read the `Overall Assessment` and `Summary` entry points
...
- [x] 3.2 Add an explicit note before `Summary` clarifying review-time
      recommendation scope
- [x] 3.3 Keep the original concern and recommendation text intact
...
- `openspec validate 2026-04-15-mcp-process-review-body-boundary-sync`
  returned `Change '2026-04-15-mcp-process-review-body-boundary-sync' is valid`
...
- interpretation:
  the staged review stayed within the expected MCP historical-review boundary
  sync slice and did not pull the user's unrelated unstaged test change into
  scope
