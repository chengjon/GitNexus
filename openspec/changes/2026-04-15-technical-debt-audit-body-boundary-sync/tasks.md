...
- [x] 1.1 Add a dedicated OpenSpec change for technical-debt-audit
      body-boundary sync
...
- [x] 2.1 Re-read the current top status-sync framing in the 2026-03-28 audit
- [x] 2.2 Re-read the `Design Documents Status` and `Tech Debt Roadmap Progress`
      table entry points
- [x] 2.3 Reconfirm the 2026-04-08 historical status-sync record
- [x] 2.4 Reconfirm the remediation roadmap entrypoint

## 3. Boundary Sync

- [x] 3.1 Add a top-level historical-baseline note for the preserved body
- [x] 3.2 Add a boundary note before `Design Documents Status`
- [x] 3.3 Add a boundary note before `Tech Debt Roadmap Progress`
- [x] 3.4 Keep the original table values intact
...
- `openspec validate 2026-04-15-technical-debt-audit-body-boundary-sync`
  returned `Change '2026-04-15-technical-debt-audit-body-boundary-sync' is valid`
...
- interpretation:
  the staged review stayed within the expected historical-table boundary sync
