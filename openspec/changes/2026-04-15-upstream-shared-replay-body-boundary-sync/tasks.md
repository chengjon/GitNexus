...
- [x] 1.1 Add a dedicated OpenSpec change for upstream shared replay
      body-boundary sync
- [x] 1.2 Bound the slice to the historical replay review, audit note, roadmap
      update, and OpenSpec record

## 2. Truth Source

- [x] 2.1 Re-read the current top follow-up pointer in the 2026-04-06 replay review
- [x] 2.2 Re-read the `Refresh Summary` and `High-Level Decision` entry points
- [x] 2.3 Reconfirm the 2026-04-08 follow-up replay record
- [x] 2.4 Reconfirm the remediation roadmap entrypoint

## 3. Boundary Sync

- [x] 3.1 Add an explicit historical-baseline note before the preserved replay body
- [x] 3.2 Add an explicit note before `High-Level Decision` clarifying later
      follow-up precedence
- [x] 3.3 Keep the original 2026-04-06 replay review text intact
...
- `openspec validate 2026-04-15-upstream-shared-replay-body-boundary-sync`
  returned `Change '2026-04-15-upstream-shared-replay-body-boundary-sync' is valid`
...
- interpretation:
  the staged review stayed within the expected upstream-replay boundary sync
