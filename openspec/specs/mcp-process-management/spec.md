# mcp-process-management Specification

## Purpose
Define how GitNexus tracks, inspects, drains, and cleans up its own MCP router
and repo-worker processes while preserving correct reindex-lock behavior during
`analyze` and MCP read paths.
## Requirements
